...
# Deep Ocean color scheme - Bioluminescent Blues
COLORS = {
    'neon_cyan': 'bright_cyan',        # Bioluminescence
    'neon_magenta': 'bright_blue',     # Deep water
    'neon_green': 'cyan',              # Ocean glow
    'neon_yellow': 'blue',             # Deep sea
    'neon_red': 'bright_cyan',         # Coral glow
    'dim': 'dim blue',                 # Dark depths
    'bg': 'black'                      # Abyss
}
