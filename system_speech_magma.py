...
# Magma color scheme - Volcanic Lava
COLORS = {
    'neon_cyan': 'bright_yellow',      # Molten core
    'neon_magenta': 'bright_red',      # Lava flow
    'neon_green': 'yellow',            # Magma glow
    'neon_yellow': 'red',              # Hot ash
    'neon_red': 'bright_red',          # Eruption
    'dim': 'dim red',                  # Cooling lava
    'bg': 'black'                      # Volcanic rock
}
