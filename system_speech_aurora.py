...
# Aurora Borealis color scheme - Northern Lights
COLORS = {
    'neon_cyan': 'bright_cyan',        # Aurora cyan
    'neon_magenta': 'bright_magenta',  # Aurora pink
    'neon_green': 'bright_green',      # Aurora waves
    'neon_yellow': 'magenta',          # Purple aurora
    'neon_red': 'green',               # Green aurora
    'dim': 'dim green',                # Night sky
    'bg': 'black'                      # Arctic night
}
