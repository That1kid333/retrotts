...
# Glacier color scheme - Ice Age Frost
COLORS = {
    'neon_cyan': 'bright_cyan',        # Ice crystals
    'neon_magenta': 'bright_blue',     # Frozen depths
    'neon_green': 'white',             # Snow peaks
    'neon_yellow': 'cyan',             # Aurora ice
    'neon_red': 'bright_white',        # Frost glow
    'dim': 'dim cyan',                 # Permafrost
    'bg': 'black'                      # Polar night
}
