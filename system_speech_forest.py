...
# Forest Dusk color scheme - Twilight Woodland
COLORS = {
    'neon_cyan': 'bright_yellow',      # Fireflies
    'neon_magenta': 'magenta',         # Dusk sky
    'neon_green': 'bright_green',      # Forest canopy
    'neon_yellow': 'green',            # Moss glow
    'neon_red': 'yellow',              # Amber fireflies
    'dim': 'dim green',                # Deep forest
    'bg': 'black'                      # Night woods
}
