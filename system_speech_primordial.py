...
# Primordial color scheme - Purple Nebula + Cyan Neon
COLORS = {
    'neon_cyan': 'bright_cyan',        # Neon highlights
    'neon_magenta': 'bright_magenta',  # Purple nebula
    'neon_green': 'cyan',              # Forest/nature hints
    'neon_yellow': 'magenta',          # Cosmic purple
    'neon_red': 'bright_magenta',      # Deep purple
    'dim': 'dim cyan',                 # Atmospheric
    'bg': 'black'                      # Deep space
}
